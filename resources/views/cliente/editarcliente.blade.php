        ...
        <div class="user_card">
          <div class="d-flex justify-content-center">
            ...
            <div class="d-flex justify-content-center form_container " >
                <form action="{{route('clientes.update',$cliente->CodigoSIS)}}" method="post">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="input-group mb-1">
                        ...
                        <input type="text" name="Nombre" class="form-control input_user" value="{{$cliente->Nombre}}" placeholder= "Ingrese nombre"  
                    ...
                    <div class="input-group mb-1">
                        ...
                        <input type="text" name="Apellido" class="form-control input_user" value="{{$cliente->Apellido}}" placeholder= "Ingrese nombre"  
                          oninput="this.value = this.value.replace(/[^\a-\z\A-\Z\ñ\Ñ ]/g,'')"  minlength ="3" maxlength ="30" required>
                    </div>
                    ...
                    <div class="input-group mb-1">
                        ...
                        <input type="text" name="CodigoSIS" class="form-control input_user" value="{{$cliente->CodigoSIS}}" placeholder="Ingrese codigo sis"
                    ...
                    <div class="input-group mb-1">
                        ...
                        <input type="text" name="Email" class="form-control input_user" value="{{$cliente->Email}}" placeholder= "ej: gpmcheco@mail.com" required maxlength="50">
                    </div>
                    ...
                    <div class="input-group mb-1">
                        ...
                        <input type="text" name="Telefono" class="form-control input_user" value="{{$cliente->Telefono}}" placeholder="Ingrese numero telef/cel"
                    ...
                    <div clas="vehiculo" id="vehiculo_section" style="display: none;">
                     ...
                     <div class="input-group mb-1">
                        ...
                        <input type="text" name="Placa" class="form-control input_user" value="{{$cliente->Placa}}" placeholder= "Ingrese Placa"  
                    ...
                    <div class="input-group mb-1">
                        ...
                        <input type="text" name="Vehiculo" class="form-control input_user" value="{{$cliente->Vehiculo}}" placeholder= "Ingrese el tipo de Vehiculo"  
                          oninput="this.value = this.value.replace(/[^\a-\z\A-\Z\ñ\Ñ ]/g,'')"  minlength ="3" maxlength ="30" required>
                    </div>
                    </div>    
