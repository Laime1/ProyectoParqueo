      ...
      <div class="d-flex justify-content-center h-100 mt-5" >
        <div class="user_card">
          <div class="d-flex justify-content-center">
            ...
            <form action="{{route('personal.update',$personal->codigosispersonal )}}" method="post">                    
                    @csrf
                    @method('PUT')
                    ...
                    <div class="input-group mb-1">
                        ...
                        <input type="text" name="nombrepersonal" class="form-control input_user" value="{{$personal->nombrepersonal}}" placeholder= "Ingrese nombre"  
                    ...
                    <div class="input-group mb-1">
                        ...
                        <input type="text" name="apellidopersonal" class="form-control input_user" value="{{$personal->apellidopersonal}}" placeholder= "Ingrese nombre"  
                          oninput="this.value = this.value.replace(/[^\a-\z\A-\Z\ñ\Ñ ]/g,'')"  minlength ="3" maxlength ="30" required>
                    </div>
                    ...
                    <div class="input-group mb-1">
                        ...
                        <input type="text" name="codigosispersonal" class="form-control input_user" value="{{$personal->codigosispersonal}}" placeholder="Ingrese codigo sis"
                    ...
                    <div class="input-group mb-1">
                        ...
                        <input type="text" name="telefonopersonal" class="form-control input_user" value="{{$personal->telefonopersonal}}" placeholder="Ingrese numero telef/cel"
                    ...
                    <div class="input-group mb-1">
                        ...
                        <input type="text" name="email" class="form-control input_user" value="{{$personal->email}}" placeholder= "ej: gpmcheco@mail.com" required maxlength="50">
                    </div>
                    ...
                    <div class="input-group mb-1">
                        ...
                        <input type="text" name="cargopersonal" class="form-control input_user" value="{{$personal->cargopersonal}}" placeholder= "Ingrese cargo"  
                          oninput="this.value = this.value.replace(/[^\a-\z\A-\Z\ñ\Ñ ]/g,'')"  minlength ="3" maxlength ="30" required>
                    </div>
                    ...
                    <div class="input-group mb-1">
                        ...
                        <input type="text" name="turnopersonal" class="form-control input_user" value="{{$personal->turnopersonal}}" placeholder= "Ingrese el turno"  
                          oninput="this.value = this.value.replace(/[^\a-\z\A-\Z\ñ\Ñ ]/g,'')"  minlength ="3" maxlength ="30" required>
                    </div>
